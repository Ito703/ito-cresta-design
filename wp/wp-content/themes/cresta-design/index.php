...
<body class="index">
    ...
    <div class="wrap">
        <div class="mv">
            ...
            <div class="slider">
                <div class="slide" style="background-image: url(<?php echo APP_URL; ?>img/index/fv-bgi_01.jpg);"></div>
                <div class="slide" style="background-image: url(<?php echo APP_URL; ?>img/index/fv-bgi_02.jpg);"></div>
                <div class="slide" style="background-image: url(<?php echo APP_URL; ?>img/index/fv-bgi_03.jpg);"></div>
            </div>
        </div>
        ...
        <main>
            <section class="concept" id="concept">
                <div class="inner">
                    ...
                    <figure class="concept__contents">
                        ...
                        <div class="img">
                            <img src="<?php echo APP_URL; ?>img/index/concept-image.jpg" alt="">
                        </div>
                    </figure>
                </div>
                ...
                <div class="inner">
                    <ul class="card-list">
                        <li>
                            <a href="">
                                <div class="img">
                                    <img src="<?php echo APP_URL; ?>img/index/card-img01.jpg" alt="">
                                </div>
                        ...
                        <li>
                            <a href="">
                                <div class="img">
                                    <img src="<?php echo APP_URL; ?>img/index/card-img02.jpg" alt="">
                                </div>
                        ...
                        <li>
                            <a href="">
                                <div class="img">
                                    <img src="<?php echo APP_URL; ?>img/index/card-img03.jpg" alt="">
                                </div>
                                <p>新規サイトを公開しました。今回のサイトは白と黒を基調にしたミニマルなデザインになっています。</p>
                            </a>
                        </li>
            ...
            <section class="service" id="service">
                ...
                <ul class="service__link">
                    <li>
                        <a href="#">
                            <div class="img"><img src="<?php echo APP_URL; ?>img/index/service-img01.jpg" alt=""></div>
                            <span class="title">Hearing</span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <div class="img"><img src="<?php echo APP_URL; ?>img/index/service-img02.jpg" alt=""></div>
                            <span class="title">Planning</span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <div class="img"><img src="<?php echo APP_URL; ?>img/index/service-img03.jpg" alt=""></div>
